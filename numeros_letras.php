...
<body>
    <form action="numeros_letras.php" method="post">
        <table border="1" cellpadding="5" cellspacing="0">
            <thead>
                <tr>
                    <td colspan="2">CONVERTIR NUMEROS A LETRAS HASTA 99</td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        class convertir_numeros_letras{
                            ...
                            $especiales = [11=>'ONCE', 12=>'DOCE', 13=>'TRECE', 14=>'CATORCE', 15=>'QUINCE', 
                                ...
                                26=>'VEINTISEIS', 27=>'VEINTISIETE', 28=>'VEINTIOCHO', 29=>'VEINTINUEVE', 100=>'CIEN'];
                                ...
                                for($i=$inicio; $i<=$fin; $i++){
                                    ...
                                    if( strlen( $i )==2 ){
                                        if( ($i>10 && $i<20)  || ($i>20 && $i<30) ){
                                            ...
                                            $numDecenas = $decenas[ str_split($i)[0] ];
                                            $numUnidades = $unidades[ str_split($i)[1] ];
